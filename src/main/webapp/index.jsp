...
<div>
    ...
    <div class="max-w-2x1 mx-auto my-96 w-1/2 rounded-3xl bg-white py-5 text-center shadow-xl">
        ...
        <form method="post" action="/converter">
            <div class="mx-8 my-5 grid gap-4">
                <div class="mx-8 my-5 pb-5">
                    <label for="amount" class="flex items-center text-xl"> Enter Amount: </label>
                    <input class="w-full appearance-none rounded-lg border-2 border-blue-700 p-2 placeholder-blue-800 focus:outline-none focus:ring" type="number" min="0" id="amount" name="amount" value="${amount}" required />
                </div>
        ...
        %>
            ...
            <button class="rounded-lg m-8 bg-blue-300 px-4 py-1 text-xl font-semibold hover:bg-blue-800 hover:text-white" type="submit">Calculate</button>
